...
class OperationHelper(BasePage):
    ...
    def test_contact_us(self):
        ...
        time.sleep(10) # Увеличенная задержка в 10 секунд
        ...
        self.find_element(TestSearchLocators.LOCATOR_OUR_NAME_FIELD).send_keys("Testovich13")
        self.find_element(TestSearchLocators.LOCATOR_EMAIL_FIELD).send_keys("Testovich13@mail.ru")
